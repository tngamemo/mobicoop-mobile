          ...
          <div class="mc-register-form-content">
            ...
            <ion-item class="mc-register-form-item" lines="none">
              <ion-checkbox
                ...
                slot="start"
              ></ion-checkbox>
              <ion-label class="mc-register-form-label no-white-space" color="primary">{{ $t('solidaryTransport.register.form.fields.driver') }}</ion-label>
            </ion-item>

            <div class="mc-register-form-item as-language">
              <ion-label class="mc-register-form-label no-white-space" color="primary">{{$t('solidaryTransport.register.form.fields.languages')}}</ion-label>

              <div class="mc-register-form-checkbox-wrapper">
                <ion-item class="mc-register-form-item" lines="none" v-for="(item, index) in languages.properties" :key="index">
                  <ion-checkbox class="mc-register-form-checkbox" :name="item.value" :value="item.checked" color="success" slot="start" @ionChange="item.checked = $event.target.checked"
                  ></ion-checkbox>
                  <ion-label class="mc-register-form-label no-white-space" color="primary">{{ item.label }}</ion-label>
                </ion-item>
                <ion-item class="mc-register-form-item as-other">
            ...
            <div class="mc-register-form-actions is-active">
              <ion-button class="mc-register-form-action as-light" color="light" @click="$refs.proof.click()">
