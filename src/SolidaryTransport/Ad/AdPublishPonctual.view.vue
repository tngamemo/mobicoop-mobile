        ...
        <div class="mc-st-form">
          ...
          <div class="mc-st-form-content">
            <div class="mc-st-form-header">
              <div class="mc-st-form-title">{{$t('solidaryTransport.ad.publish.steps.ponctual')}}</div>
            ...
            <ion-item class="mc-st-form-item" v-on:click="displayGeoSearch('register_address', 'search')">
              <ion-label position="floating">{{$t('solidaryTransport.ad.publish.form.fields.when.departure.date')}} *</ion-label>
            ...
            <div class="mc-st-form-item as-trip" v-if="trip.selected === 'round-trip'">
              <ion-label class="mc-st-form-label as-title no-white-space" color="primary">{{$t('solidaryTransport.ad.publish.form.fields.when.return')}}</ion-label>

              <div class="mc-st-form-checkbox-wrapper">
                <ion-item class="mc-st-form-item">
                  <ion-checkbox class="mc-st-form-checkbox" slot="start" :checked="true" color="success"></ion-checkbox>
                  <ion-input class="mc-st-form-input" type="text" :placeholder="$t('solidaryTransport.ad.publish.form.fields.when.specificReturn')"></ion-input>
                </ion-item>
          ...
          <div class="mc-st-form-controls with-multiple">
            ...
            <ion-button class="mc-st-form-control" color="success" v-html="$t('solidaryTransport.buttons.next')" @click="$router.push({name:'solidaryTransport.home.ad.ponctual.summary', query: {type: type}})"></ion-button>
          </div>
...
export default {
  name: 'solidaryTransport.ad.publish.ponctual',
  components: {},
  data () {
    return {
      updating: false,
      ...
      departureHours: {
        other: '',
        selected: this.$t('solidaryTransport.ad.publish.form.when.departure.hours')[0].value,
        properties: this.$t('solidaryTransport.ad.publish.form.when.departure.hours')
      },
      returnHours: {
        other: '',
        selected: this.$t('solidaryTransport.ad.publish.form.when.return')[0].value,
        properties: this.$t('solidaryTransport.ad.publish.form.when.return')
      },
    }
  },
  computed: {},
