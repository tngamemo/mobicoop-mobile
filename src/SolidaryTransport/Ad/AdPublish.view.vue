  ...
  <ion-page>
    <ion-header no-border>
      <ion-toolbar color="primary">
        ...
        <ion-title>{{$t('solidaryTransport.ad.publish.title')}} <sup>1/3</sup></ion-title>
      </ion-toolbar>
    </ion-header>
        ...
        <div class="mc-st-form">
          ...
          <div class="mc-st-form-content">
            <div class="mc-st-form-header">
              <div class="mc-st-form-title">{{$t('solidaryTransport.ad.publish.steps.init')}}</div>
            ...
            <div class="mc-st-form-item as-transport">
              <ion-label class="mc-st-form-label as-title no-white-space" color="primary">{{$t('solidaryTransport.ad.publish.form.fields.transports')}}</ion-label>
              ...
              <div class="mc-st-form-checkbox-wrapper">
                ...
                <ion-item class="mc-st-form-item as-other">
                  <ion-label position="floating">{{$t('solidaryTransport.ad.publish.form.fields.otherTransports')}}</ion-label>
            ...
            <div class="mc-st-form-item as-transport">
              <ion-label class="mc-st-form-label as-title no-white-space" color="primary">{{$t('solidaryTransport.ad.publish.form.fields.transportsDetails')}}</ion-label>
              ...
              <div class="mc-st-form-checkbox-wrapper">
                ...
                <ion-item class="mc-st-form-item as-other">
                  <ion-label position="floating">{{$t('solidaryTransport.ad.publish.form.fields.otherTransportsDetails')}}</ion-label>
                  <ion-input class="mc-st-form-input" type="text"></ion-input>
                </ion-item>
              </div>
            </div>
            ...
            <div class="mc-st-form-item as-supporting">
              <ion-label class="mc-st-form-label as-title no-white-space" color="primary">{{$t('solidaryTransport.ad.publish.form.fields.supporting')}}</ion-label>
            ...
            <div class="mc-st-form-item as-comment">
              <ion-label class="mc-st-form-label as-title no-white-space" color="primary">{{$t('solidaryTransport.ad.publish.form.fields.comment')}}</ion-label>

              <ion-item class="mc-st-form-item as-textarea" lines="none">
                <ion-textarea :placeholder="$t('solidaryTransport.ad.publish.form.fields.commentSample')" :auto-grow="true"></ion-textarea>
              </ion-item>
            </div>

            <div class="mc-st-form-item as-transport">
              <ion-label class="mc-st-form-label as-title no-white-space" color="primary">{{$t('solidaryTransport.ad.publish.form.fields.frequency')}}</ion-label>
          ...
          <div class="mc-st-form-controls with-multiple">
            ...
            <template v-if="frequency.selected === 'ponctual'">
              <ion-button class="mc-st-form-control" color="success" v-html="$t('solidaryTransport.buttons.next')" @click="$router.push({name:'solidaryTransport.home.ad.ponctual'})"></ion-button>
            </template>
            <template v-if="frequency.selected === 'regular'">
              <ion-button class="mc-st-form-control" color="success" v-html="$t('solidaryTransport.buttons.next')" @click="$router.push({name:'solidaryTransport.home.ad.regular'})"></ion-button>
            </template>
          </div>
...
export default {
  name: 'solidaryTransport.ad.publish',
  components: {},
  data () {
    return {
      updating: false,
      transports: {
        other: '',
        properties: this.$t('solidaryTransport.ad.publish.form.transports')
      },
      transportsDetails: {
        other: '',
        properties: this.$t('solidaryTransport.ad.publish.form.transportsDetails')
      },
      supporting: {
        selected: this.$t('solidaryTransport.ad.publish.form.supporting')[0].value,
        properties: this.$t('solidaryTransport.ad.publish.form.supporting')
      },
      addresses: {
        departure: undefined,
        arrival: undefined
      ...
      frequency: {
        selected: this.$t('solidaryTransport.ad.publish.form.frequency')[0].value,
        properties: this.$t('solidaryTransport.ad.publish.form.frequency')
      },
    }
  },
  computed: {},
