      ...
      <div class="mc-st-container">
        <div class="mc-st-form">
          ...
          <div class="mc-st-form-controls with-multiple">
            ...
            <ion-button class="mc-st-form-control" color="success" v-html="$t('solidaryTransport.buttons.next')" @click="$router.push({name: $route.name + '.summary', query: {type: type}})"></ion-button>
          </div>
