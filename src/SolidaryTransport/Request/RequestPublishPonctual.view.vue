        ...
        <div class="mc-st-form">
          ...
          <div class="mc-st-form-content">
            <div class="mc-st-form-header">
              <div class="mc-st-form-title">{{$t('solidaryTransport.request.publish.steps.ponctual')}}</div>
            ...
            <div class="mc-st-form-item">
              <ion-label class="mc-st-form-label as-title no-white-space" color="primary">{{$t('solidaryTransport.request.publish.form.fields.when.departure.date')}}</ion-label>
              ...
              <div class="mc-st-form-checkbox-wrapper">
                <ion-item class="mc-st-form-item">
                  ...
                  <ion-input class="mc-st-form-input" type="text" :placeholder="$t('solidaryTransport.request.publish.form.fields.when.departure.specificDate')"></ion-input>
                </ion-item>
...
export default {
  name: 'solidaryTransport.request.publish.ponctual',
  components: {},
  data () {
    return {
      updating: false,
      departureDates: {
        other: '',
        selected: this.$t('solidaryTransport.request.publish.form.when.departure.dates')[0].value,
        properties: this.$t('solidaryTransport.request.publish.form.when.departure.dates')
      },
      departureHours: {
        other: '',
